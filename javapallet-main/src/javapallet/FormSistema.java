...
public class FormSistema extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnRemove.setBackground(new java.awt.Color(204, 153, 255));
    ...
    private void btnRemoveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRemoveActionPerformed
        ...
        while(!pilha.isEmpty()){
          p = pilha.peek();
          if(p.getProduto().equals(txtProduto.getText())){ //verificação 
              ...
              mostra();
              break; // Procura pelo produto acabou
          }// fim if equals
          else{
        ...
        while(!paux.isEmpty()){
             pilha.push(paux.pop());// colocar o que ta na auxiliar na pilha principal e remover o que ta na auxiliar
                mostra();
        }
